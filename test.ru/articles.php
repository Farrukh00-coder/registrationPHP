                        ...
                        <article class="article">
                          ...
                          <div class="article__info">
                            ...
                            <div class="article__info__meta">
                              ...
                              ?>
                              <small>Категория: <a href="/articles.php
                                ?categorie=<?php echo $art_cat['id']; ?>"><?php echo $art_cat['title']; ?></a></small>
                            </div>
                  ...
                  if ( $articles_exist == true)
                      {
                        ...
                        if ( $page > 1 )
                        {
                          echo "<a href='/articles.php?page=". ($page - 1). "'>&laquoПредыдущая страница</a>    ";
                        }
                        if( $page < $total_pages )
                        {
